...
- [Cost Analysis — AI Multi-Agent](#cost-analysis--ai-multi-agent)
  - [Table of Contents](#table-of-contents)
  - [Monthly Cost Summary](#monthly-cost-summary)
    - [Development (personal account)](#development-personal-account)
    - [Production (small scale: ~100 tasks/day)](#production-small-scale-100-tasksday)
  - [Why Multi-Agent Costs 4× More Than Single Agent](#why-multi-agent-costs-4-more-than-single-agent)
    - [Token Flow Through the Pipeline](#token-flow-through-the-pipeline)
    - [Cost per Task by Provider](#cost-per-task-by-provider)
    - [Cost Comparison Across Portfolio](#cost-comparison-across-portfolio)
  ...
  - [What Alternatives Cost More](#what-alternatives-cost-more)
    - [Alternative 1: AutoGen instead of CrewAI](#alternative-1-autogen-instead-of-crewai)
    - [Alternative 2: AWS Step Functions for Agent Orchestration](#alternative-2-aws-step-functions-for-agent-orchestration)
    - [Alternative 3: LangGraph Multi-Agent instead of CrewAI](#alternative-3-langgraph-multi-agent-instead-of-crewai)
